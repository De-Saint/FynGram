...
/* harmony import */ var _checkout_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./checkout-routing.module */ "./src/app/checkout/checkout-routing.module.ts");
/* harmony import */ var _checkout_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./checkout.page */ "./src/app/checkout/checkout.page.ts");
...
CheckoutPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _checkout_routing_module__WEBPACK_IMPORTED_MODULE_6__["CheckoutPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".input {\n  border: 0.5px solid #d2d2d2;\n  border-radius: 3px;\n  font-size: 0.9em !important;\n}\n\n.label {\n  font-size: 12px;\n}\n\n.small {\n  font-size: 9px;\n  color: #787878;\n}\n\n.icon {\n  font-size: 21px;\n}\n\n.bottom {\n  position: absolute;\n  bottom: 10px;\n  width: 90%;\n  left: 50%;\n  transform: translate(-50%, 0%);\n}\n\n.add-payment-div {\n  border: 1px solid #ddd;\n  margin-bottom: 10px;\n  padding: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _home_service_shop_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../home/service/shop.service */ "./src/app/home/service/shop.service.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
...
let CheckoutPage = class CheckoutPage {
    constructor(fun, loadingCtrl, route, shopService, authService) {
        this.fun = fun;
    ...
    processOrder(paytype, shiptypeId, addressid) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const loading = yield this.loadingCtrl.create({
                cssClass: 'my-custom-class',
                message: 'Please wait...',
    ...
    paymentDone(ref) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (ref.status === 'success') {
                ...
                yield loading.present();
                this.sid = this.authService.currentUserDataValue.sid;
                this.shopService.placeOrder(String(this.sid), 'CheckOut Payment', String(this.shiptypeId), String(this.useraddress.id), String(this.resp.totalamount), String(ref.reference), String(ref.transaction))
                    .subscribe(res => {
                    loading.dismiss().catch(() => { });
                    if (res.code === 200) {
                        this.done(res.msg);
