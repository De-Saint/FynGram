(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sellers-details-details-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppAdminusersSellersDetailsDetailsPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdminusersSellersDetailsDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdminusersSellersDetailsDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdminusersSellersDetailsDetailsPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdminusersSellersDetailsDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(DetailsPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.paramMap.subscribe(function (paramMap) {
              ...
              _this.sellerId = paramMap.get('sellerId');
              _this.seller = _this.fun.getNavigationData(_this.sellerId);
              console.log(_this.seller);
            });
          }
        }, {
          key: "onDelete",
          value: function onDelete(seller) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      this.fun.removeConform('seller').then(function (res) {
                          ...
                          return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                              switch (_context.prev = _context.next) {
                                ...
                                case 3:
                                  this.authService.DeleteCustomer(String(seller.userid)).subscribe(function (res) {
                                    loading.dismiss()["catch"](function () {});

                                    if (res.code === 200) {
                                      _this3.fun.presentToast(res.msg);

                                      _this3.router.navigate(['/', 'adminusers', 'tabs', 'sellers']);
                                    } else {
                                      _this3.fun.presentToast(res.msg);
                                    }
                                  }, function (error) {
      ...
      DetailsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/adminusers/sellers/details/details.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./details.page.scss */
        "./src/app/adminusers/sellers/details/details.page.scss"))["default"]]
      })], DetailsPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=sellers-details-details-module-es5.js.map