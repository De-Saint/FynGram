  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function srcAppAdminprofileProfileProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      ProfilePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _profile_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProfilePageRoutingModule"]],
    ...
    function srcAppAdminprofileProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(authService, loadingCtrl, fun) {
          ...
          this.updateForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
            ...
            password2: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null, {
              updateOn: 'blur',
              validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(6)]
            }),
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      this.authService.GetUserDetails(sid).subscribe(function (res) {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 6:
                      this.sid = this.authService.currentUserDataValue.sid;
                      this.authService.UpdateProfile(String(this.sid), String(this.updateForm.value.first_name), String(this.updateForm.value.last_name), String(this.updateForm.value.password), String(this.updateForm.value.password2), String(this.updateForm.value.phone)).subscribe(function (res) {
                        loading.dismiss()["catch"](function () {});

                        if (res.code === 200) {
                          _this2.GetUserDetails(_this2.sid);
                  ...
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 6:
                      ...
                      this.authService.UpdateProfile(String(this.sid), String(this.updateForm.value.first_name), String(this.updateForm.value.last_name), String(this.updateForm.value.password), String(this.updateForm.value.password2), String(this.updateForm.value.phone)).subscribe(function (res) {
                        ...
                        if (res.code === 200) {
                          _this4.GetUserDetails(_this4.sid);
                  ...
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 6:
                      ...
                      this.authService.UpdateProfile(String(this.sid), String(this.updateForm.value.first_name), String(this.updateForm.value.last_name), String(this.updateForm.value.password), String(this.updateForm.value.password2), String(this.updateForm.value.phone)).subscribe(function (res) {
                        ...
                        if (res.code === 200) {
                          _this6.GetUserDetails(_this6.sid);
