  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cart-cart-module"], {
    ...
    function srcAppCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CartPage = /*#__PURE__*/function () {
        function CartPage(dataService, fun, modalController, nav, loadingCtrl, authService, shopService, alertController) {
                          ...
                          return regeneratorRuntime.wrap(function _callee4$(_context4) {
                            while (1) {
                              switch (_context4.prev = _context4.next) {
                                ...
                                case 4:
                                  this.shopService.DeleteOption('Cart', String(cart.id), cart.ProductDetails.id).subscribe(function (resp) {
                                    loading.dismiss()["catch"](function () {});
