...
const routes = [
    ...
    {
        path: 'authenticate',
        loadChildren: () => Promise.all(/*! import() | authenticate-authenticate-module */[__webpack_require__.e("default~authenticate-authenticate-module~buy-buy-module~category-category-module~help-help-module~se~29d5e236"), __webpack_require__.e("authenticate-authenticate-module")]).then(__webpack_require__.bind(null, /*! ./authenticate/authenticate.module */ "./src/app/authenticate/authenticate.module.ts")).then(m => m.AuthenticatePageModule)
    },
    {
        path: 'home',
    ...
    {
        path: 'search',
        loadChildren: () => Promise.all(/*! import() | search-search-module */[__webpack_require__.e("default~authenticate-authenticate-module~buy-buy-module~category-category-module~help-help-module~se~29d5e236"), __webpack_require__.e("search-search-module")]).then(__webpack_require__.bind(null, /*! ./search/search.module */ "./src/app/search/search.module.ts")).then(m => m.SearchPageModule)
    },
    {
