  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stock-stock-module"], {
    ...
    function srcAppAdmininventoryStockStockPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StockPage = /*#__PURE__*/function () {
        function StockPage(fun, shopService, loadingCtrl, authService) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      this.shopService.GetStockMovement(sid).subscribe(function (res) {
                        loading.dismiss()["catch"](function () {});

                        if (res.code === 200) {
                          _this.returns = res.data;
                          _this.show = true;
                        } else {
                          _this.show = false;
                        }
      ...
      StockPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
        selector: 'app-stock',
